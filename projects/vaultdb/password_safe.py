...
if connect == PASSWORD:
    conn = sqlite3.connect('mysafe.db') # <====== file name
    try:
        conn.execute(''' CREATE TABLE SAFE (FULL_NAME TEXT PRIMARY KEY NOT NULL, EXTENSION TEXT NOT NULL, FILES TEXT NOT NULL);''')
    ...
    while True:
        ...
        if input_ == "q":
            break
        if input_ == "o":
            file_type = raw_input("What is the filetype of the file you wish to open\n?")
            file_name = raw_input("Waht is the name of the file you wish to open?\n")
        ...
        if input_ == "s":
            PATH = raw_input("Type in the full path to thr file you want to store.\nExample: /Users/rod/Desktop/filename.py\n")
            ...
            if EXTENSION == "IMAGE":
                ...
                file_string = base64.b64encode(cv2.imecode('.jpg', IMAGE)[1]).decode()
